...
rupturaRouter.get('/', authMiddleware, ownDataOnly, async (req, res) => {
    try {
        ...
        const mesUsar = parseInt(mes || new Date().getMonth() + 1);
        const anoUsar = parseInt(ano || new Date().getFullYear());
...
module.exports = { rupturaRouter, rotRouter, cadRouter, tickRouter, devRouter };
